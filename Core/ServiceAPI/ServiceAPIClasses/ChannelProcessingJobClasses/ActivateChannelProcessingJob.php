...
class ActivateChannelProcessingJob extends ChannelProcessingJobBase {
    ...
    public function RunService($json) {
        ...
        try {
            ...
            $logger->log("Core::ServiceAPI::ChannelProcessingJobClasses::ActivateChannelProcessingJob::RunService [An exception was thrown]", \PEAR_LOG_DEBUG);
            $logger->log("Core::ServiceAPI::ChannelProcessingJobClasses::ActivateChannelProcessingJob::RunService [$message]", \PEAR_LOG_ERR);
